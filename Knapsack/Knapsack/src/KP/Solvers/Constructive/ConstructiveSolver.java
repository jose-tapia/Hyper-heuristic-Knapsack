    ...
    public ConstructiveHeuristic getHeuristic(String heuristic) throws NoSuchHeuristicException {        
        switch (heuristic) {
            ...
            case "MAX_PROFIT2_PER_WEIGHT_UNIT":
                return new ConstructiveHeuristic(Heuristic.MAX_PROFIT2_PER_WEIGHT_UNIT);
            case "MAX_PROFIT_PER_WEIGHT_UNIT2":
                return new ConstructiveHeuristic(Heuristic.MAX_PROFIT_PER_WEIGHT_UNIT2);
            case "AVG_PROFIT":
                return new ConstructiveHeuristic(Heuristic.AVG_PROFIT);
